...
class WechatUser(models.Model):
    ...
    register_type = fields.Selection(defs.WechatUserRegisterType.__dict__.items(), string='注册来源',
    ...
    ip = fields.Char('登陆IP')
    status = fields.Selection(defs.WechatUserStatus.__dict__.items(), string='状态',
                              default=defs.WechatUserStatus.default[0])
