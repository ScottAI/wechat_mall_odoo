...
class Transportation(models.Model):
    ...
    transport_type = fields.Selection(defs.TransportType.__dict__.items(), string='运输方式',
                                      default='express', required=True)
    unit = fields.Selection(defs.TransportationUnit.__dict__.items(), string='单位', compute='_compute_unit')
...
class DistrictTransportation(models.Model):
    ...
    unit = fields.Selection(defs.TransportationUnit.__dict__.items(), string='单位',
