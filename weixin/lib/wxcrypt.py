...
class WXBizDataCrypt:
    ...
    def decrypt(self, encrypted_data, iv):
        ...
        #decrypted = json.loads(self._unpad(str(cipher.decrypt(encrypted_data)),encoding='utf-8'))
        decrypted = json.loads(str(self._unpad(cipher.decrypt(encrypted_data)), encoding='utf-8'))
